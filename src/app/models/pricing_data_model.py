...
class PricingData(Base):
    ...
    high_battery_health = Column(Integer, default=0)
    low_battery_health = Column(Integer, default=0)
    ...
    active_single_order = Column(Boolean, default=False)
    ...
    def to_dict(self):
        return {
            ...
            "active_single_order": self.active_single_order
        }
    ...
    def to_dict_with_metadata(self):
        return {
            ...
            "active_single_order":
                {"value": self.active_single_order,
                 "type": "boolean"
                 }
        }
